<x-app-layout title="Dashboard">
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="/" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
                Go To Website
            </a>
        </div>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                        ...
                        <tbody class="bg-white dark:bg-zinc-800 divide-y divide-gray-200 dark:divide-zinc-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-zinc-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $product->subcategory }}</td>
